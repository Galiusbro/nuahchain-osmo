...
//line /Users/gp/go/pkg/mod/github.com/cockroachdb/pebble@v1.1.2/internal/manual/manual.go:1:1
...
func New(n int) []byte {
	...
	//   to Go.
	ptr := ( /*line :40:9*/_Cfunc_calloc /*line :40:16*/)( /*line :40:18*/_Ctype_size_t /*line :40:26*/(n), 1)
	if ptr == nil {
...
func Free(b []byte) {
	if cap(b) != 0 {
		...
		func() { _cgo0 := /*line :58:10*/ptr; _cgoCheckPointer(_cgo0, nil); /*line :58:14*/_Cfunc_free(_cgo0); }()
	}
}
