...
Example:
	nuahd testnet --v 4 --output-dir ./output --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "nuahd", "Home directory of the node's daemon configuration")
...
func InitTestnet(
	...
	for i := 0; i < numValidators; i++ {
		...
		kb, err := keyring.New(sdk.KeyringServiceName(), keyringBackend, nodeDir, inBuf, nil)
		if err != nil {
			return err
		}
