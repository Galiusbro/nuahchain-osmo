...
func (suite *HooksTestSuite) TestCW20ICS20() {
	...
	balanceStakeReceiver := NUAHAppB.BankKeeper.GetBalance(suite.chainB.GetContext(), suite.chainB.SenderAccount.GetAddress(), stakeAB)
	...
	balanceStakeReceiver2 := NUAHAppB.BankKeeper.GetBalance(suite.chainB.GetContext(), suite.chainB.SenderAccount.GetAddress(), stakeAB)
