...
- **$UPGRADE_VERSION Proposal**: [Proposal Page](https://www.mintscan.io/osmosis/proposals/$PROPOSAL_ID)
- **$UPGRADE_VERSION Upgrade Block Height**: $UPGRADE_BLOCK
- **$UPGRADE_VERSION Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/osmosis/blocks/$UPGRADE_BLOCK)
...
1. Monitor Osmosis until it reaches the specified upgrade block height: $UPGRADE_BLOCK.
