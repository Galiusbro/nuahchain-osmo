...
//line /Users/gp/go/pkg/mod/github.com/!data!dog/zstd@v1.5.5/zstd_stream.go:1:1
package zstd
...
type Writer struct {
	...
	resultBuffer     * /*line :87:20*/_Ctype_compressStream2_result /*line :87:44*/
}
...
func NewWriterLevelDict(w io.Writer, level int, dict []byte) *Writer {
	var err error
	ctx := ( /*line :122:9*/_Cfunc_ZSTD_createCStream /*line :122:28*/)()

	// Load dictionnary if any
	if dict != nil {
		err = getError(int(func() _Ctype_size_t{ _cgo0 := /*line :126:49*/ctx; _cgoIndex1 := &/*line :127:20*/dict; _cgo1 := /*line :127:4*/unsafe.Pointer(&(*_cgoIndex1)[0]); var _cgo2 _Ctype_size_t = _Ctype_size_t /*line :128:12*/(len(dict)); _cgoCheckPointer(_cgo0, nil); _cgoCheckPointer(_cgo1, *_cgoIndex1); return /*line :129:4*/_Cfunc_ZSTD_CCtx_loadDictionary(_cgo0, _cgo1, _cgo2); }()))
	}

	if err == nil {
		// Only set level if the ctx is not in error already
		err = getError(int(func() _Ctype_size_t{ _cgo0 := /*line :134:47*/ctx; var _cgo1 _Ctype_ZSTD_cParameter = /*line :134:52*/_Ciconst_ZSTD_c_compressionLevel /*line :134:77*/; var _cgo2 _Ctype_int = _Ctype_int /*line :134:84*/(level); _cgoCheckPointer(_cgo0, nil); return /*line :134:92*/_Cfunc_ZSTD_CCtx_setParameter(_cgo0, _cgo1, _cgo2); }()))
	}
	...
	return &Writer{
		...
		firstError:       err,
		underlyingWriter: w,
		resultBuffer:     new( /*line :145:25*/_Ctype_compressStream2_result /*line :145:49*/),
	}
}
...
func (w *Writer) Write(p []byte) (int, error) {
	...
	func() { var _cgo0 *_Ctype_struct_compressStream2_result_s = /*line :177:3*/w.resultBuffer; _cgo1 := /*line :178:3*/w.ctx; _cgoIndex2 := &/*line :179:19*/w.dstBuffer; _cgo2 := /*line :179:3*/unsafe.Pointer(&(*_cgoIndex2)[0]); var _cgo3 _Ctype_size_t = _Ctype_size_t /*line :180:11*/(len(w.dstBuffer)); _cgoIndex4 := &/*line :181:19*/srcData; _cgo4 := /*line :181:3*/unsafe.Pointer(&(*_cgoIndex4)[0]); var _cgo5 _Ctype_size_t = _Ctype_size_t /*line :182:11*/(len(srcData)); _cgoCheckPointer(_cgo1, nil); _cgoCheckPointer(_cgo2, *_cgoIndex2); _cgoCheckPointer(_cgo4, *_cgoIndex4); /*line :183:3*/_Cfunc_ZSTD_compressStream2_wrapper(_cgo0, _cgo1, _cgo2, _cgo3, _cgo4, _cgo5); }()
...
func (w *Writer) Flush() error {
	...
	for ret > 0 {
		...
		func() { var _cgo0 *_Ctype_struct_compressStream2_result_s = /*line :232:4*/w.resultBuffer; _cgo1 := /*line :233:4*/w.ctx; _cgoIndex2 := &/*line :234:20*/w.dstBuffer; _cgo2 := /*line :234:4*/unsafe.Pointer(&(*_cgoIndex2)[0]); var _cgo3 _Ctype_size_t = _Ctype_size_t /*line :235:12*/(len(w.dstBuffer)); _cgo4 := /*line :236:4*/unsafe.Pointer(srcPtr); var _cgo5 _Ctype_size_t = _Ctype_size_t /*line :237:12*/(len(w.srcBuffer)); _cgoCheckPointer(_cgo1, nil); _cgoCheckPointer(_cgo2, *_cgoIndex2); _cgoCheckPointer(_cgo4, nil); /*line :238:4*/_Cfunc_ZSTD_compressStream2_flush(_cgo0, _cgo1, _cgo2, _cgo3, _cgo4, _cgo5); }()
		ret = int(w.resultBuffer.return_code)
		if err := getError(ret); err != nil {
			return err
		}
...
func (w *Writer) Close() error {
	...
	for ret > 0 {
		...
		func() { var _cgo0 *_Ctype_struct_compressStream2_result_s = /*line :276:4*/w.resultBuffer; _cgo1 := /*line :277:4*/w.ctx; _cgoIndex2 := &/*line :278:20*/w.dstBuffer; _cgo2 := /*line :278:4*/unsafe.Pointer(&(*_cgoIndex2)[0]); var _cgo3 _Ctype_size_t = _Ctype_size_t /*line :279:12*/(len(w.dstBuffer)); _cgo4 := /*line :280:4*/unsafe.Pointer(srcPtr); var _cgo5 _Ctype_size_t = _Ctype_size_t /*line :281:12*/(len(w.srcBuffer)); _cgoCheckPointer(_cgo1, nil); _cgoCheckPointer(_cgo2, *_cgoIndex2); _cgoCheckPointer(_cgo4, nil); /*line :282:4*/_Cfunc_ZSTD_compressStream2_finish(_cgo0, _cgo1, _cgo2, _cgo3, _cgo4, _cgo5); }()
		ret = int(w.resultBuffer.return_code)
		if err := getError(ret); err != nil {
			return err
		}
		...
		_, err := w.underlyingWriter.Write(w.dstBuffer[:written])
		if err != nil {
			func() _Ctype_size_t{ _cgo0 := /*line :291:23*/w.ctx; _cgoCheckPointer(_cgo0, nil); return /*line :291:29*/_Cfunc_ZSTD_freeCStream(_cgo0); }()
			return err
		}
	...
	return getError(int(func() _Ctype_size_t{ _cgo0 := /*line :303:41*/w.ctx; _cgoCheckPointer(_cgo0, nil); return /*line :303:47*/_Cfunc_ZSTD_freeCStream(_cgo0); }()))
}
...
func (w *Writer) SetNbWorkers(n int) error {
	...
	if err := getError(int(func() _Ctype_size_t{ _cgo0 := /*line :315:50*/w.ctx; var _cgo1 _Ctype_ZSTD_cParameter = /*line :315:57*/_Ciconst_ZSTD_c_nbWorkers /*line :315:75*/; var _cgo2 _Ctype_int = _Ctype_int /*line :315:82*/(n); _cgoCheckPointer(_cgo0, nil); return /*line :315:86*/_Cfunc_ZSTD_CCtx_setParameter(_cgo0, _cgo1, _cgo2); }())); err != nil {
		w.firstError = err
...
var cSize = func() int {
	v := int(( /*line :331:11*/_Cfunc_ZSTD_DStreamInSize /*line :331:30*/)())
	if v <= 0 {
...
// invocation allow for a one-time check for validity.
var dSize = func() int {
	v := int(( /*line :341:11*/_Cfunc_ZSTD_DStreamOutSize /*line :341:31*/)())
	if v <= 0 {
...
type reader struct {
	ctx                 * /*line :372:23*/_Ctype_ZSTD_DCtx /*line :372:34*/
	...
	resultBuffer        * /*line :381:23*/_Ctype_decompressStream2_result /*line :381:49*/
...
func NewReaderDict(r io.Reader, dict []byte) io.ReadCloser {
	var err error
	ctx := ( /*line :397:9*/_Cfunc_ZSTD_createDStream /*line :397:28*/)()
	if len(dict) == 0 {
		err = getError(int(func() _Ctype_size_t{ _cgo0 := /*line :399:41*/ctx; _cgoCheckPointer(_cgo0, nil); return /*line :399:45*/_Cfunc_ZSTD_initDStream(_cgo0); }()))
	} else {
		err = getError(int(func() _Ctype_size_t{ _cgo0 := /*line :401:40*/ctx; var _cgo1 _Ctype_ZSTD_ResetDirective = /*line :401:45*/_Ciconst_ZSTD_reset_session_only /*line :401:70*/; _cgoCheckPointer(_cgo0, nil); return /*line :401:71*/_Cfunc_ZSTD_DCtx_reset(_cgo0, _cgo1); }()))
		if err == nil {
			// Only load dictionary if we succesfully inited the context
			err = getError(int(func() _Ctype_size_t{ _cgo0 := /*line :405:5*/ctx; _cgoIndex1 := &/*line :406:21*/dict; _cgo1 := /*line :406:5*/unsafe.Pointer(&(*_cgoIndex1)[0]); var _cgo2 _Ctype_size_t = _Ctype_size_t /*line :407:13*/(len(dict)); _cgoCheckPointer(_cgo0, nil); _cgoCheckPointer(_cgo1, *_cgoIndex1); return /*line :407:25*/_Cfunc_ZSTD_DCtx_loadDictionary(_cgo0, _cgo1, _cgo2); }()))
		}
	}
	...
	return &reader{
		...
		resultBuffer:        new( /*line :419:28*/_Ctype_decompressStream2_result /*line :419:54*/),
		underlyingReader:    r,
	}
}
...
func (r *reader) Close() error {
	...
	cPool.Put(&cb)
	dPool.Put(&db)
	return getError(int(func() _Ctype_size_t{ _cgo0 := /*line :439:41*/r.ctx; _cgoCheckPointer(_cgo0, nil); return /*line :439:47*/_Cfunc_ZSTD_freeDStream(_cgo0); }()))
}
...
func (r *reader) Read(p []byte) (int, error) {
	...
	for {
		...
		func() { var _cgo0 *_Ctype_struct_decompressStream2_result_s = /*line :515:4*/r.resultBuffer; _cgo1 := /*line :516:4*/r.ctx; _cgoIndex2 := &/*line :517:20*/r.decompressionBuffer; _cgo2 := /*line :517:4*/unsafe.Pointer(&(*_cgoIndex2)[0]); var _cgo3 _Ctype_size_t = _Ctype_size_t /*line :518:12*/(len(r.decompressionBuffer)); _cgo4 := /*line :519:4*/unsafe.Pointer(srcPtr); var _cgo5 _Ctype_size_t = _Ctype_size_t /*line :520:12*/(len(src)); _cgoCheckPointer(_cgo1, nil); _cgoCheckPointer(_cgo2, *_cgoIndex2); _cgoCheckPointer(_cgo4, nil); /*line :521:4*/_Cfunc_ZSTD_decompressStream_wrapper(_cgo0, _cgo1, _cgo2, _cgo3, _cgo4, _cgo5); }()
