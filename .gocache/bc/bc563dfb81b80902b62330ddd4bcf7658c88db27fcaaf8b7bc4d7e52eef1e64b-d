...
//line /Users/gp/go/pkg/mod/github.com/!cosm!wasm/wasmvm/v2@v2.2.4/internal/api/memory.go:1:1
package api
...
func uninitializedUnmanagedVector()  /*line :44:37*/_Ctype_UnmanagedVector /*line :44:54*/ {
	return  /*line :45:9*/_Ctype_UnmanagedVector /*line :45:26*/{}
}

func newUnmanagedVector(data []byte)  /*line :48:38*/_Ctype_UnmanagedVector /*line :48:55*/ {
	if data == nil {
		return ( /*line :50:10*/_Cfunc_new_unmanaged_vector /*line :50:31*/)(cbool(true), cu8_ptr(nil), cusize(0))
	} else if len(data) == 0 {
		// in Go, accessing the 0-th element of an empty array triggers a panic. That is why in the case
		// of an empty `[]byte` we can't get the internal heap pointer to the underlying array as we do
		// below with `&data[0]`.
		// https://play.golang.org/p/xvDY3g9OqUk
		return ( /*line :56:10*/_Cfunc_new_unmanaged_vector /*line :56:31*/)(cbool(false), cu8_ptr(nil), cusize(0))
	} else {
		// This will allocate a proper vector with content and return a description of it
		return ( /*line :59:10*/_Cfunc_new_unmanaged_vector /*line :59:31*/)(cbool(false), cu8_ptr(unsafe.Pointer(&data[0])), cusize(len(data)))
	}
}

func copyAndDestroyUnmanagedVector(v  /*line :63:38*/_Ctype_UnmanagedVector /*line :63:55*/) []byte {
	var out []byte
	if v.is_none {
		out = nil
		...
		out = func() []byte{ _cgo0 := /*line :72:19*/unsafe.Pointer(v.ptr); var _cgo1 _Ctype_int = /*line :72:42*/cint(v.len); _cgoCheckPointer(_cgo0, nil); return /*line :72:54*/_Cfunc_GoBytes(_cgo0, _cgo1); }()
	}
	( /*line :74:2*/_Cfunc_destroy_unmanaged_vector /*line :74:27*/)(v)
	return out
}

func optionalU64ToPtr(val  /*line :78:27*/_Ctype_OptionalU64 /*line :78:40*/) *uint64 {
	if val.is_some {
...
func copyU8Slice(view  /*line :87:23*/_Ctype_U8SliceView /*line :87:36*/) []byte {
	if view.is_none {
		return nil
	}
	if view.len == 0 {
	...
	// C.GoBytes create a copy (https://stackoverflow.com/a/40950744/2013738)
	res := func() []byte{ _cgo0 := /*line :96:19*/unsafe.Pointer(view.ptr); var _cgo1 _Ctype_int = /*line :96:45*/cint(view.len); _cgoCheckPointer(_cgo0, nil); return /*line :96:60*/_Cfunc_GoBytes(_cgo0, _cgo1); }()
	return res
}
