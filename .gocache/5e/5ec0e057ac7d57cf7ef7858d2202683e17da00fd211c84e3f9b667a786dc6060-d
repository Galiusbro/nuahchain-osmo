...
//line /Users/gp/go/pkg/mod/github.com/!data!dog/zstd@v1.5.5/zstd.go:1:1
package zstd
...
func Decompress(dst, src []byte) ([]byte, error) {
	...
	written := int(func() _Ctype_size_t{ _cgoIndex0 := &/*line :147:19*/dst; _cgo0 := /*line :147:3*/unsafe.Pointer(&(*_cgoIndex0)[0]); var _cgo1 _Ctype_size_t = _Ctype_size_t /*line :148:11*/(len(dst)); _cgoIndex2 := &/*line :149:19*/src; _cgo2 := /*line :149:3*/unsafe.Pointer(&(*_cgoIndex2)[0]); var _cgo3 _Ctype_size_t = _Ctype_size_t /*line :150:11*/(len(src)); _cgoCheckPointer(_cgo0, *_cgoIndex0); _cgoCheckPointer(_cgo2, *_cgoIndex2); return /*line :150:22*/_Cfunc_ZSTD_decompress(_cgo0, _cgo1, _cgo2, _cgo3); }())
