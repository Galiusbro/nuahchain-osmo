...
import (
	...
	poolincentiveskeeper "github.com/osmosis-labs/osmosis/v30/x/pool-incentives/keeper"
	...
	"github.com/osmosis-labs/osmosis/v30/x/superfluid"
	superfluidkeeper "github.com/osmosis-labs/osmosis/v30/x/superfluid/keeper"
...
func (appKeepers *AppKeepers) InitNormalKeepers(
	...
	freeAccountKeeper := freeaccountkeeper.NewKeeper(
		appCodec,
		runtime.NewKVStoreService(appKeepers.keys[freeaccounttypes.StoreKey]),
		bApp.Logger(),
	...
	wasmCapabilities = append(wasmCapabilities, "nuah")
