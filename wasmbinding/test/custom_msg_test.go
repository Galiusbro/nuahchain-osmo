...
func executeCustom(t *testing.T, ctx sdk.Context, osmosis *app.NUAHApp, contract sdk.AccAddress, sender sdk.AccAddress, msg bindings.OsmosisMsg, funds sdk.Coin) error {
	t.Helper()
