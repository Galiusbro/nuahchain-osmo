...
Osmosis v16 Gov Prop: <https://www.mintscan.io/osmosis/proposals/556>

Countdown: <https://www.mintscan.io/osmosis/blocks/10517000>
...
Copy the current v15 nuahd binary into the
...
cp $GOPATH/bin/nuahd ~/.nuahd/cosmovisor/upgrades/v15/bin
```
...
make build
cp build/nuahd ~/.nuahd/cosmovisor/upgrades/v16/bin
```
...
1. Wait for Osmosis to reach the upgrade height 10517000
