# Mainnet Upgrade Guide: From Version v24 to v25

## Overview

- **v25 Proposal**: [Proposal Page](https://www.mintscan.io/osmosis/proposals/TODO)
- **v25 Upgrade Block Height**: TODO
- **v25 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/osmosis/blocks/TODO)
...
cp $GOPATH/bin/nuahd ~/.nuahd/cosmovisor/upgrades/v24/bin
```
...
```sh
mkdir -p ~/.nuahd/cosmovisor/upgrades/v25/bin
cd $HOME/osmosis
git pull
git checkout v25.0.0
make build
cp build/nuahd ~/.nuahd/cosmovisor/upgrades/v25/bin
```

At the designated block height, Cosmovisor will automatically upgrade to version v25.
