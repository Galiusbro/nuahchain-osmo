# Mainnet Upgrade Guide: From Version v29 to v30
...
mkdir -p ~/.nuahd/cosmovisor/upgrades/v29/bin
cp $GOPATH/bin/nuahd ~/.nuahd/cosmovisor/upgrades/v29/bin
```
...
```sh
mkdir -p ~/.nuahd/cosmovisor/upgrades/v30/bin
cd $HOME/osmosis
git pull
git checkout v30.0.0
make build
cp build/nuahd ~/.nuahd/cosmovisor/upgrades/v30/bin
```
