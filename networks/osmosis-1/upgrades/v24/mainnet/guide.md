# Mainnet Upgrade Guide: From Version v23 to v24

## Overview

- **v24 Proposal**: [Proposal Page](https://www.mintscan.io/osmosis/proposals/763)
- **v24 Upgrade Block Height**: 14830300
- **v24 Upgrade Countdown**: [Block Countdown](https://www.mintscan.io/osmosis/blocks/14830300)
...
cp $GOPATH/bin/nuahd ~/.nuahd/cosmovisor/upgrades/v23/bin
```
...
```sh
mkdir -p ~/.nuahd/cosmovisor/upgrades/v24/bin
cd $HOME/osmosis
git pull
git checkout v24.0.0
make build
cp build/nuahd ~/.nuahd/cosmovisor/upgrades/v24/bin
```

At the designated block height, Cosmovisor will automatically upgrade to version v24.
