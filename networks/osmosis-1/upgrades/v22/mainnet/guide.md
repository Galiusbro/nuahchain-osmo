# Mainnet Upgrade Guide: From Version v21 to v22
...
mkdir -p ~/.nuahd/cosmovisor/upgrades/v21/bin
cp $GOPATH/bin/nuahd ~/.nuahd/cosmovisor/upgrades/v21/bin
```
...
make build
cp build/nuahd ~/.nuahd/cosmovisor/upgrades/v22/bin
```
