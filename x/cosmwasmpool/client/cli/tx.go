...
func NewCreateCWPoolCmd() (*osmocli.TxCliDesc, *model.MsgCreateCosmWasmPool) {
	return &osmocli.TxCliDesc{
		...
		Example:          "nuahd tx cosmwasmpool create-pool 1 '{\"pool_asset_denoms\":[\"uion\",\"uosmo\"]}' --from lo-test1 --keyring-backend test --chain-id localnuah --fees 875uosmo -b=block",
		NumArgs:          2,
...
func NewCmdUploadCodeIdAndWhitelistProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Example: "nuahd tx gov submit-proposal upload-code-id-and-whitelist x/cosmwasmpool/bytecode/transmuter.wasm --from lo-test1 --keyring-backend test --title \"Test\" --summary \"Test\" -b=block --chain-id localnuah --fees=100000uosmo --gas=20000000",
