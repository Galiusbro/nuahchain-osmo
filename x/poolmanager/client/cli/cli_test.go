...
import (
	...
	"github.com/osmosis-labs/osmosis/v30/x/poolmanager/client/queryproto"
	poolmanagertestutil "github.com/osmosis-labs/osmosis/v30/x/poolmanager/client/testutil"
...
// 	}{
// 		{
// 			"query pool estimate swap exact amount in", // nuahd query poolmanager estimate-swap-exact-amount-in 1 cosmos1n8skk06h3kyh550ad9qketlfhc2l5dsdevd3hq 10.0stake --swap-route-pool-ids=1 --swap-route-denoms=node0token
// 			[]string{
// 				"1",
