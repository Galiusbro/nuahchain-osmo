...
func (s *KeeperTestSuite) TestBuildTwoPoolRoute() {
	...
	cases := []struct {
	...
	}{
		{
			...
			poolId:   54,
			expectedRoute: []TestRoute{
				{PoolId: 54, InputDenom: types.OsmosisDenomination, OutputDenom: "nuah"},
				{PoolId: 55, InputDenom: "nuah", OutputDenom: types.OsmosisDenomination},
			},
			hasRoute: true,
		},
		{
			...
			poolId:   54,
			expectedRoute: []TestRoute{
				{PoolId: 55, InputDenom: types.OsmosisDenomination, OutputDenom: "nuah"},
				{PoolId: 54, InputDenom: "nuah", OutputDenom: types.OsmosisDenomination},
			},
			hasRoute: true,
		},
		{
