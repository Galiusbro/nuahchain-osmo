	...
	tests := []struct {
	...
	}{
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:       1,
				UpperTick:       10,
				TokensProvided:  sdk.NewCoins(sdk.NewCoin("nuah", osmomath.OneInt()), sdk.NewCoin("osmo", osmomath.OneInt())),
		...
		},
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:       1,
				UpperTick:       10,
				TokensProvided:  sdk.Coins{sdk.Coin{Denom: "nuah", Amount: osmomath.NewInt(-10)}, sdk.NewCoin("osmo", osmomath.OneInt())},
				TokenMinAmount0: osmomath.OneInt(),
				TokenMinAmount1: osmomath.OneInt(),
			},
			expectPass: false,
		},
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:       1,
				UpperTick:       10,
				TokensProvided:  sdk.Coins{sdk.NewCoin("nuah", osmomath.OneInt()), sdk.Coin{Denom: "osmo", Amount: osmomath.NewInt(-10)}},
				TokenMinAmount0: osmomath.OneInt(),
				TokenMinAmount1: osmomath.OneInt(),
			},
			expectPass: false,
		},
		{
			...
			msg: types.MsgCreatePosition{
				...
				LowerTick:       1,
				UpperTick:       10,
				TokensProvided:  sdk.NewCoins(sdk.NewCoin("nuah", osmomath.ZeroInt()), sdk.NewCoin("osmo", osmomath.ZeroInt())),
				TokenMinAmount0: osmomath.OneInt(),
				TokenMinAmount1: osmomath.OneInt(),
			},
			expectPass: false,
