...
func TestBasicFunctionality(t *testing.T) {
	...
	require.Equal(t, "freeaccount", types.ModuleName)

	// Test that store key is correct
	require.Equal(t, "freeaccount", types.StoreKey)
	...
	msg := types.NewMsgCreateFreeAccount(authorityAddr.String(), testAddr.String())
